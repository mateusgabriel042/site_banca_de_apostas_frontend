<template>
	<div class="area-bets-match">
		<div class="area-odds">
			...
			<div class="odds">
				<div class="col-list-4 col-odd">{{matche?.home?.name}} <span class="color-odd">{{oddsMain?.full_time_result[0]?.OD}}</span></div>
				<div class="col-list-4 col-odd">Empate <span class="color-odd">{{oddsMain.full_time_result[1]?.OD}}</span></div>
				<div class="col-list-4 col-odd">{{matche?.away?.name}} <span class="color-odd">{{oddsMain.full_time_result[2]?.OD}}</span></div>
			</div>
		</div>
		...
		<div class="area-odds">
			...
			<div class="odds">
				<div class="col-list-4 col-odd">{{matche?.home?.name}} ou Empate<span class="color-odd">{{oddsMain.double_chance[0]?.OD}}</span></div>
				<div class="col-list-4 col-odd">Empate ou {{matche?.away?.name}} <span class="color-odd">{{oddsMain.double_chance[1]?.OD}}</span></div>
				<div class="col-list-4 col-odd">{{matche?.home?.name}} ou {{matche?.away?.name}} <span class="color-odd">{{oddsMain.double_chance[2]?.OD}}</span></div>
			</div>
		</div>

		<div class="area-odds">
			<label class="teste">Proxímo a marcar</label>
			<div class="odds">
				<div class="col-list-4 col-odd">{{matche?.home?.name}}<span class="color-odd">{{parseFloat(oddsMain.next_goal[0]?.OD).toFixed(2)}}</span></div>
				<div class="col-list-4 col-odd">Sem gol<span class="color-odd">{{parseFloat(oddsMain.next_goal[1]?.OD).toFixed(2)}}</span></div>
				<div class="col-list-4 col-odd">{{matche?.away?.name}} <span class="color-odd">{{parseFloat(oddsMain.next_goal[2]?.OD).toFixed(2)}}</span></div>
			</div>
		</div>
		...
		<div class="area-odds">
			...
			<div class="odds">
				<div class="col-list-4 col-odd center bg-gray-1">{{oddsMain.goals_over_under[0]?.NA}}</div>
				<div class="col-list-4 col-odd center bg-gray-2"><span class="color-odd">{{oddsMain.goals_over_under[2]?.OD}}</span></div>
				<div class="col-list-4 col-odd center bg-gray-2"><span class="color-odd">{{oddsMain.goals_over_under[4]?.OD}}</span></div>
			</div>
			<div class="odds" v-for="(item, index) in oddsMain.goals_alternatives_over_under" :key="index">
				<div class="col-list-4 col-odd center bg-gray-1">{{item.over?.HA}}</div>
				<div class="col-list-4 col-odd center bg-gray-2"><span class="color-odd">{{item.over?.OD}}</span></div>
				<div class="col-list-4 col-odd center bg-gray-2"><span class="color-odd">{{item.under?.OD}}</span></div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	import SearchOddsMainMatcheLive from "../../../services/search-odds-main-matche-live.service";
	...
	export default {
	    ...
	    mounted() {
	    	BetService.getMatcheInLive(this.$route.params.idMache).then(
				(response) => {
					this.matche = response.data.matche;
					
					const searchOddsMainMatcheLive = new SearchOddsMainMatcheLive(response.data.odds[0]);

					this.oddsMain.full_time_result = searchOddsMainMatcheLive.getOddsResultFinal();
					this.oddsMain.double_chance = searchOddsMainMatcheLive.getOddsDoubleChance();
					this.oddsMain.next_goal = searchOddsMainMatcheLive.getOddsNextGoal();
					this.oddsMain.goals_over_under = searchOddsMainMatcheLive.getOddsGoalsOverUnder();
					this.oddsMain.goals_alternatives_over_under = searchOddsMainMatcheLive.getOddsGoalsAlternativesOverUnder();
					console.log(this.oddsMain.goals_alternatives_over_under);
